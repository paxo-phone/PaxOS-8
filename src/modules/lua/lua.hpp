...
class LuaInterpreter {
    ...
    public:
        ...
        static std::string readError() {return error_message;}
        static void pushError(std::string msg) {error_message.append(msg);}
        static bool crashed;
};
Window* LuaInterpreter::current_root = nullptr;
vector<LuaEvent> LuaInterpreter::events;
std::string LuaInterpreter::dir;
std::string LuaInterpreter::data;
std::string LuaInterpreter::error_message = "";
bool LuaInterpreter::crashed = false;
