...
void execute_lua(lua_State* L, const std::string& functionName) {
    ...
    {
        LuaInterpreter::pushError("Error executing Lua function '" + functionName + "': " + lua_tostring(L, -1));
        LuaInterpreter::crashed = true;
    }
}