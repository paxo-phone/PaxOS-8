...
Label2::Label2(int16_t x, int16_t y, int16_t width, int16_t height, std::string text) : Gui(x, y, width, height)
{
    this->text = text;
    this->fontHeight = BASE_FONT_SIZE;
    setTextColor(COLOR_BLACK);
...
LGFX_Sprite* Label2::selfDetermination()
{
